...
public class SenderController {
    ...
    @PostMapping()
    public ResponseEntity<Response> addSender(@RequestAttribute String traceId, @RequestAttribute Long userId, @RequestBody SenderDto senderDto) {
    ...
    public ResponseEntity<Response> senderList(@RequestAttribute String traceId, @RequestAttribute Long userId, @RequestParam(defaultValue = "") String searchParam, @RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "3") int size) {
